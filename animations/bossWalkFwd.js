function bossWalkForward(skeleton, frameRate, initialPos, initialRot) {
    ...
    const mainPos = new BABYLON.Animation("walkFwdPos", "position", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_RELATIVE);
    const keyFrames0 = [];
    keyFrames0.push({
        frame: 0,
    ...
    const chestPos = new BABYLON.Animation("bossWalkFwdPos", "position", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames1 = [];
    keyFrames1.push({
        frame: 0,
    ...
    const chestRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames2 = [];
    keyFrames2.push({
        frame: 0,
    ...
    keyFrames2.push({
        frame: 4 * frameRate/3,
        value: new BABYLON.Vector3(currRot.x+0.108, currRot.y+0.0, currRot.z+0.0)
    });
    keyFrames2.push({
        frame: 11 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x-0.047, currRot.y+0.0, currRot.z+0.0)
    ...
    const shoulderLRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames3 = [];
    keyFrames3.push({
        frame: 0,
        value: currRot
    ...
    const shoulderRRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames4 = [];
    keyFrames4.push({
        frame: 0,
        value: currRot
    ...
    const upperArmLRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames5 = [];
    keyFrames5.push({
        frame: 0,
    ...
    keyFrames5.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x-0.35, currRot.y+0.573, currRot.z-0.822)
    ...
    const upperArmRRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames6 = [];
    keyFrames6.push({
        frame: 0,
    ...
    const lowerArmLRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames7 = [];
    keyFrames7.push({
        frame: 0,
    ...
    const lowerArmRRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames8 = [];
    keyFrames8.push({
        frame: 0,
        value: new BABYLON.Vector3(currRot.x+0.138, currRot.y-0.578, currRot.z+0.168)
    });
    keyFrames8.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.375, currRot.y-0.21, currRot.z+0.388)
    });
    keyFrames8.push({
        frame: 4 * frameRate/3,
        value: new BABYLON.Vector3(currRot.x+0.101, currRot.y-0.378, currRot.z+0.016)
    });
    keyFrames8.push({
        frame: 11 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.138, currRot.y-0.578, currRot.z+0.168)
    ...
    const palmRRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames15 = [];
    keyFrames15.push({
        frame: 0,
        value: new BABYLON.Vector3(0.0, 0.5, 0.0)
    });
    keyFrames15.push({
        frame: 11 * frameRate/6,
        value: new BABYLON.Vector3(0.0, 0.5, 0.0)
    ...
    const upperLegLRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames9 = [];
    keyFrames9.push({
        frame: 0,
    ...
    keyFrames9.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x-0.49, currRot.y+0.3, currRot.z-0.199)
    });
    keyFrames9.push({
        frame: 11 * frameRate/12,
    ...
    keyFrames9.push({
        frame: 4 * frameRate/3,
        value: new BABYLON.Vector3(currRot.x+1.07, currRot.y+0.198, currRot.z+0.205)
    });
    keyFrames9.push({
        frame: 11 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.152, currRot.y+0.354, currRot.z+0.11)
    ...
    const upperLegRRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames10 = [];
    keyFrames10.push({
        frame: 0,
        value: new BABYLON.Vector3(currRot.x-0.152, currRot.y+0.154, currRot.z+0.01)
    });
    keyFrames10.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.864, currRot.y+0.131, currRot.z+0.187)
    });
    keyFrames10.push({
        frame: 11 * frameRate/12,
    ...
    keyFrames10.push({
        frame: 4 * frameRate/3,
        value: new BABYLON.Vector3(currRot.x-0.49, currRot.y+0.126, currRot.z-0.085)
    });
    keyFrames10.push({
        frame: 11 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x-0.152, currRot.y+0.154, currRot.z+0.01)
    ...
    const lowerLegLRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames11 = [];
    keyFrames11.push({
        frame: 0,
    ...
    keyFrames11.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.657, currRot.y+0.048, currRot.z-0.15)
    });
    keyFrames11.push({
    ...
    keyFrames11.push({
        frame: 4 * frameRate/3,
        value: new BABYLON.Vector3(currRot.x+0.313, currRot.y-0.0, currRot.z-0.15)
    });
    keyFrames11.push({
        frame: 11 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.38, currRot.y-0.0, currRot.z-0.15)
    ...
    const lowerLegRRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames12 = [];
    keyFrames12.push({
        frame: 0,
    ...
    keyFrames12.push({
        ...
        value: new BABYLON.Vector3(currRot.x+0.02, currRot.y+0.192, currRot.z-0.05)
    });
    keyFrames12.push({
        frame: 4 * frameRate/3,
        value: new BABYLON.Vector3(currRot.x+0.613, currRot.y+0.104, currRot.z+0.05)
    });
    keyFrames12.push({
        frame: 11 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.323, currRot.y+0.065, currRot.z+0.05)
    ...
    const footLRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames13 = [];
    keyFrames13.push({
        frame: 0,
    ...
    const footRRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames14 = [];
    keyFrames14.push({
        frame: 0,
    ...
    const capeRot = new BABYLON.Animation("bossWalkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames16 = [];
    keyFrames16.push({
        frame: 0,
        value: new BABYLON.Vector3(currRot.x+0.1, currRot.y+0.0, currRot.z+0.0)
    ...
    keyFrames16.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x-0.15, currRot.y+0.0, currRot.z+0.0)
    });
    keyFrames16.push({
        frame: 11 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.05, currRot.y+0.0, currRot.z+0.0)
    });
    keyFrames16.push({
        frame: 4 * frameRate/3,
        value: new BABYLON.Vector3(currRot.x-0.15, currRot.y+0.0, currRot.z+0.0)
...
function groupBossWalkFwd(skeleton) {
    const bossWalkFwdGroup = new BABYLON.AnimationGroup("bossWalkFwdGroup");
    //bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("main")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("main")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder L")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("shoulder L")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder R")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("shoulder R")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("palm R")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("palm R")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot L")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("foot L")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot R")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("foot R")]);
    bossWalkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("cape")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("cape")]);

    return bossWalkFwdGroup;
}
