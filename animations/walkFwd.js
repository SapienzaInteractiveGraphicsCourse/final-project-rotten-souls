function walkForward(skeleton, frameRate, initialPos, initialRot) {
    ...
    const chestPos = new BABYLON.Animation("walkFwdPos", "position", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames1 = [];
    keyFrames1.push({
        frame: 0,
    ...
    const chestRot = new BABYLON.Animation("walkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames2 = [];
    keyFrames2.push({
        frame: 0,
    ...
    keyFrames2.push({
        frame: 4 * frameRate/3,
        value: new BABYLON.Vector3(currRot.x+0.148, currRot.y+0.0, currRot.z+0.0)
    });
    keyFrames2.push({
        frame: 11 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x-0.047, currRot.y+0.0, currRot.z+0.0)
    ...
    const shoulderLRot = new BABYLON.Animation("walkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames3 = [];
    keyFrames3.push({
        frame: 0,
        value: currRot
    ...
    const shoulderRRot = new BABYLON.Animation("walkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames4 = [];
    keyFrames4.push({
        frame: 0,
        value: currRot
    ...
    const upperArmLRot = new BABYLON.Animation("walkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames5 = [];
    keyFrames5.push({
        frame: 0,
    ...
    const upperArmRRot = new BABYLON.Animation("walkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames6 = [];
    keyFrames6.push({
        frame: 0,
    ...
    const lowerArmLRot = new BABYLON.Animation("walkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames7 = [];
    keyFrames7.push({
        frame: 0,
    ...
    const lowerArmRRot = new BABYLON.Animation("walkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames8 = [];
    keyFrames8.push({
        frame: 0,
        value: new BABYLON.Vector3(currRot.x+0.238, currRot.y-0.178, currRot.z+0.168)
    });
    keyFrames8.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.675, currRot.y-0.51, currRot.z+0.388)
    });
    keyFrames8.push({
        frame: 4 * frameRate/3,
        value: new BABYLON.Vector3(currRot.x+0.101, currRot.y-0.178, currRot.z+0.016)
    });
    keyFrames8.push({
        frame: 11 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.238, currRot.y-0.178, currRot.z+0.168)
    ...
    const upperLegLRot = new BABYLON.Animation("walkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames9 = [];
    keyFrames9.push({
        frame: 0,
    ...
    keyFrames9.push({
        frame: 4 * frameRate/3,
        value: new BABYLON.Vector3(currRot.x+1.27, currRot.y+0.198, currRot.z+0.205)
    });
    keyFrames9.push({
        frame: 11 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.152, currRot.y+0.354, currRot.z+0.11)
    ...
    const upperLegRRot = new BABYLON.Animation("walkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames10 = [];
    keyFrames10.push({
        frame: 0,
    ...
    keyFrames10.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+1.064, currRot.y+0.131, currRot.z+0.187)
    });
    keyFrames10.push({
        frame: 11 * frameRate/12,
    ...
    const lowerLegLRot = new BABYLON.Animation("walkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames11 = [];
    keyFrames11.push({
        frame: 0,
    ...
    keyFrames11.push({
        frame: 4 * frameRate/3,
        value: new BABYLON.Vector3(currRot.x+0.913, currRot.y-0.0, currRot.z-0.15)
    });
    keyFrames11.push({
        frame: 11 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.38, currRot.y-0.0, currRot.z-0.15)
    ...
    const lowerLegRRot = new BABYLON.Animation("walkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames12 = [];
    keyFrames12.push({
        frame: 0,
    ...
    const footLRot = new BABYLON.Animation("walkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames13 = [];
    keyFrames13.push({
        frame: 0,
    ...
    const footRRot = new BABYLON.Animation("walkFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames14 = [];
    keyFrames14.push({
        frame: 0,
...
function groupWalkFwd(skeleton) {
    const walkFwdGroup = new BABYLON.AnimationGroup("walkFwdGroup");
    //walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("main")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("main")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder L")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("shoulder L")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder R")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("shoulder R")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot L")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("foot L")]);
    walkFwdGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot R")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("foot R")]);
