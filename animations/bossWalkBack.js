...
function bossWalkBack(skeleton, frameRate, initialPos, initialRot) {
    ...
    const chestPos = new BABYLON.Animation("bossWalkBackPos", "position", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames1 = [];
    keyFrames1.push({
        frame: 0,
    ...
    const chestRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames2 = [];
    keyFrames2.push({
        frame: 0,
    ...
    const shoulderLRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames3 = [];
    keyFrames3.push({
        frame: 0,
        value: currRot
    ...
    const shoulderRRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames4 = [];
    keyFrames4.push({
        frame: 0,
        value: currRot
    ...
    const upperArmLRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames5 = [];
    keyFrames5.push({
        frame: 0,
    ...
    const upperArmRRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames6 = [];
    keyFrames6.push({
        frame: 0,
    ...
    const lowerArmLRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames7 = [];
    keyFrames7.push({
        frame: 0,
    ...
    const lowerArmRRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames8 = [];
    keyFrames8.push({
        frame: 0,
    ...
    const palmRRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames15 = [];
    keyFrames15.push({
        frame: 0,
        value: new BABYLON.Vector3(0.0, 0.4, 0.0)
    });
    keyFrames15.push({
        frame: 11 * frameRate/6,
        value: new BABYLON.Vector3(0.0, 0.4, 0.0)
    ...
    const upperLegLRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames9 = [];
    keyFrames9.push({
        frame: 0,
    ...
    keyFrames9.push({
        frame: 4 * frameRate/3,
        value: new BABYLON.Vector3(currRot.x+0.67, currRot.y+0.198, currRot.z+0.205)
    });
    keyFrames9.push({
        frame: 11 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.152, currRot.y+0.354, currRot.z+0.11)
    ...
    const upperLegRRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames10 = [];
    keyFrames10.push({
        frame: 0,
    ...
    keyFrames10.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.664, currRot.y+0.131, currRot.z+0.187)
    });
    keyFrames10.push({
        frame: 11 * frameRate/12,
    ...
    const lowerLegLRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames11 = [];
    keyFrames11.push({
        frame: 0,
    ...
    const lowerLegRRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames12 = [];
    keyFrames12.push({
        frame: 0,
    ...
    const footLRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames13 = [];
    keyFrames13.push({
        frame: 0,
    ...
    const footRRot = new BABYLON.Animation("bossWalkBackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames14 = [];
    keyFrames14.push({
        frame: 0,
...
function groupBossWalkBack(skeleton) {
    //C'ERA UNA MOLESTA PRIMA ANIMAZIONE (in indice 0) NELL'ARRAY DELLE ANIMAZIONI DELLE BONES ("anim" sulla proprietà "_matrix") (l'ho rimossa a mano dal file .babylon)
    const bossWalkBackGroup = new BABYLON.AnimationGroup("bossWalkBackGroup");
    //bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("main")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("main")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[4], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[5], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder L")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("shoulder L")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder R")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("shoulder R")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("palm R")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("palm R")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot L")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("foot L")]);
    bossWalkBackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot R")].animations[2], skeleton.bones[skeleton.getBoneIndexByName("foot R")]);

    return bossWalkBackGroup;
}
