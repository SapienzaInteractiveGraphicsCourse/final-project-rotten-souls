...
function playerIdleAnimation(skeleton, frameRate, initialPos, initialRot) {
    ...
    //palm R
    //Inserted only to reset the wristle/palm position after other animations
    ...
    keyFrames16.push({
        frame: 0,
        value: new BABYLON.Vector3(0.0, 0.0, 0.0)
    });
    keyFrames16.push({
        frame: 2 * frameRate,
        value: new BABYLON.Vector3(0.0, 0.0, 0.0)
...
function groupIdle(skeleton) {
    ...
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder L")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("shoulder L")]);
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder R")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("shoulder R")]);
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("head")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("head")]);
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")]);
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")]);
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")]);
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")]);
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")]);
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")]);
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("palm R")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("palm R")]);
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")]);
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")]);
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot L")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("foot L")]);
    idleGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot R")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("foot R")]);
