function dodgeRight(skeleton, frameRate, initialPos, initialRot) {
    var currPos;
    var currRot;
    ...
    const chestPos = new BABYLON.Animation("dodgeRightPos", "position", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames1 = [];
    keyFrames1.push({
        frame: 0,
    ...
    const chestRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames2 = [];
    keyFrames2.push({
        frame: 0,
    ...
    const shoulderLRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames3 = [];
    keyFrames3.push({
        frame: 0,
        value: currRot
    ...
    const shoulderRRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames4 = [];
    keyFrames4.push({
        frame: 0,
        value: currRot
    ...
    const upperArmLRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames5 = [];
    keyFrames5.push({
        frame: 0,
    ...
    const upperArmRRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames6 = [];
    keyFrames6.push({
        frame: 0,
    ...
    const lowerArmLRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames7 = [];
    keyFrames7.push({
        frame: 0,
    ...
    const lowerArmRRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames8 = [];
    keyFrames8.push({
        frame: 0,
    ...
    const palmRRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames9 = [];
    keyFrames9.push({
        frame: 0,
        value: currRot
    ...
    const upperLegLRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames10 = [];
    keyFrames10.push({
        frame: 0,
    ...
    keyFrames10.push({
        frame: 1 * frameRate/4,
        value: new BABYLON.Vector3(currRot.x+0.863, currRot.y+0.36, currRot.z-0.034)
    });
    keyFrames10.push({
        frame: 5 * frameRate/12,
    ...
    const upperLegRRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames11 = [];
    keyFrames11.push({
        frame: 0,
    ...
    keyFrames11.push({
        frame: 1 * frameRate/4,
        value: new BABYLON.Vector3(currRot.x+0.855, currRot.y-0.334, currRot.z+0.25)
    });
    keyFrames11.push({
        frame: 5 * frameRate/12,
    ...
    const lowerLegLRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames12 = [];
    keyFrames12.push({
        frame: 0,
    ...
    keyFrames12.push({
        frame: 1 * frameRate/4,
        value: new BABYLON.Vector3(currRot.x+0.367, currRot.y+0.015, currRot.z+0.0)
    });
    keyFrames12.push({
        frame: 7 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.203, currRot.y-0.034, currRot.z+0.06)
    });
    keyFrames12.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.204, currRot.y-0.034, currRot.z+0.06)
    ...
    const lowerLegRRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames13 = [];
    keyFrames13.push({
        frame: 0,
    ...
    keyFrames13.push({
        frame: 1 * frameRate/4,
        value: new BABYLON.Vector3(currRot.x+0.704, currRot.y-0.052, currRot.z+0.088)
    });
    keyFrames13.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.31, currRot.y+0.026, currRot.z-0.017)
    });
    keyFrames13.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.305, currRot.y+0.024, currRot.z-0.018)
    ...
    const footLRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames14 = [];
    keyFrames14.push({
        frame: 0,
    ...
    keyFrames14.push({
        frame: 1 * frameRate/4,
        value: new BABYLON.Vector3(currRot.x+0.074, currRot.y+0.009, currRot.z+0.311)
    });
    keyFrames14.push({
        frame: 5 * frameRate/12,
    ...
    const footRRot = new BABYLON.Animation("dodgeRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames15 = [];
    keyFrames15.push({
        frame: 0,
    ...
    keyFrames15.push({
        frame: 1 * frameRate/4,
        value: new BABYLON.Vector3(currRot.x-0.384, currRot.y+0.005, currRot.z-0.311)
    });
    keyFrames15.push({
        frame: 5 * frameRate/12,
...
function groupDodgeRight(skeleton) {
    const dodgeRightGroup = new BABYLON.AnimationGroup("dodgeRightGroup");
    dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[22], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[23], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    //dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder L")].animations[5], skeleton.bones[skeleton.getBoneIndexByName("shoulder L")]);
    //dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder R")].animations[6], skeleton.bones[skeleton.getBoneIndexByName("shoulder R")]);
    dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")].animations[11], skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")]);
    dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")].animations[11], skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")]);
    dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")].animations[11], skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")]);
    dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")].animations[11], skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")]);
    //dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("palm R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("palm R")]);
    dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")].animations[11], skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")]);
    dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")].animations[11], skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")]);
    dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")].animations[11], skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")]);
    dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")].animations[11], skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")]);
    dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot L")].animations[11], skeleton.bones[skeleton.getBoneIndexByName("foot L")]);
    dodgeRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot R")].animations[11], skeleton.bones[skeleton.getBoneIndexByName("foot R")]);

    return dodgeRightGroup;
}
