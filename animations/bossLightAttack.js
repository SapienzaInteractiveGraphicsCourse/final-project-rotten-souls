function bossLightAttack(skeleton, frameRate, initialPos, initialRot) {
    var currPos;
    var currRot;
    ...
    const chestPos = new BABYLON.Animation("bossLAttackPos", "position", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames1 = [];
    keyFrames1.push({
        frame: 0,
    ...
    const chestRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames2 = [];
    keyFrames2.push({
        frame: 0,
    ...
    keyFrames2.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.7, currRot.y+0.4, currRot.z+0.0)
    });
    keyFrames2.push({
        frame: 5 * frameRate/3,
        value: new BABYLON.Vector3(currRot.x+0.1, currRot.y+0.0, currRot.z+0.0)
    ...
    const shoulderLRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames3 = [];
    keyFrames3.push({
        frame: 0,
        value: currRot
    ...
    const shoulderRRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames4 = [];
    keyFrames4.push({
        frame: 0,
        value: currRot
    ...
    keyFrames4.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.3, currRot.y+1.1, currRot.z+0.0)
    });
    keyFrames4.push({
        frame: 5 * frameRate/3,
        value: currRot
    ...
    const upperArmLRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames5 = [];
    keyFrames5.push({
        frame: 0,
    ...
    const upperArmRRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames6 = [];
    keyFrames6.push({
        frame: 0,
    ...
    keyFrames6.push({
        frame: 1 * frameRate/2,
        value: new BABYLON.Vector3(currRot.x-0.851, currRot.y+0.552, currRot.z-0.605)
    });
    keyFrames6.push({
        frame: 5 * frameRate/6,
    ...
    const lowerArmLRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames7 = [];
    keyFrames7.push({
        frame: 0,
    ...
    const lowerArmRRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames8 = [];
    keyFrames8.push({
        frame: 0,
    ...
    const palmRRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames9 = [];
    keyFrames9.push({
        frame: 0,
        value: currRot
    ...
    keyFrames9.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x-0.5, currRot.y+0.42, currRot.z+0.0)
    });
    keyFrames9.push({
        frame: 5 * frameRate/3,
        value: currRot
    ...
    const upperLegLRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames10 = [];
    keyFrames10.push({
        frame: 0,
    ...
    const upperLegRRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames11 = [];
    keyFrames11.push({
        frame: 0,
    ...
    keyFrames11.push({
        ...
        value: new BABYLON.Vector3(currRot.x+1.537, currRot.y-0.284, currRot.z-0.184)
    });
    keyFrames11.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+1.28, currRot.y-0.332, currRot.z-0.108)
    });
    keyFrames11.push({
        frame: frameRate,
        value: new BABYLON.Vector3(currRot.x+1.28, currRot.y-0.332, currRot.z-0.108)
    ...
    const lowerLegLRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames12 = [];
    keyFrames12.push({
        frame: 0,
    ...
    const lowerLegRRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames13 = [];
    keyFrames13.push({
        frame: 0,
    ...
    const footLRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames14 = [];
    keyFrames14.push({
        frame: 0,
    ...
    const footRRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames15 = [];
    keyFrames15.push({
        frame: 0,
    ...
    const capeRot = new BABYLON.Animation("bossLAttackRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames16 = [];
    keyFrames16.push({
        frame: 0,
        value: currRot
    ...
    keyFrames16.push({
        frame: 1 * frameRate/2,
        value: new BABYLON.Vector3(currRot.x-0.11, currRot.y+0.2, currRot.z+0.0)
    });
    keyFrames16.push({
        frame: 5 * frameRate/6,
...
function groupBossLAttack(skeleton) {
    const bossLightAttackGroup = new BABYLON.AnimationGroup("bossLightAttackGroup");
    //bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("main")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("main")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[6], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[7], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder L")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("shoulder L")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("shoulder R")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("palm R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("palm R")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot L")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("foot L")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("foot R")]);
    bossLightAttackGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("cape")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("cape")]);

    return bossLightAttackGroup;
}
