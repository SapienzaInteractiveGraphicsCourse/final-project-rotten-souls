...
function walkRight(skeleton, frameRate, initialPos, initialRot) {
    ...
    const mainPos = new BABYLON.Animation("walkRightPos", "position", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_RELATIVE);
    const keyFrames0 = [];
    keyFrames0.push({
        frame: 0,
    ...
    const chestPos = new BABYLON.Animation("walkRightPos", "position", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames0 = [];
    keyFrames0.push({
        frame: 0,
    ...
    const chestRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames1 = [];
    keyFrames1.push({
        frame: 0,
    ...
    const headRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames2 = [];
    keyFrames2.push({
        frame: 0,
    ...
    const shoulderLRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames3 = [];
    keyFrames3.push({
        frame: 0,
        value: currRot
    ...
    const shoulderRRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames4 = [];
    keyFrames4.push({
        frame: 0,
        value: currRot
    ...
    const upperArmLRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames5 = [];
    keyFrames5.push({
        frame: 0,
    ...
    const upperArmRRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames6 = [];
    keyFrames6.push({
        frame: 0,
    ...
    const lowerArmLRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames7 = [];
    keyFrames7.push({
        frame: 0,
    ...
    const lowerArmRRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames8 = [];
    keyFrames8.push({
        frame: 0,
    ...
    const upperLegLRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames9 = [];
    keyFrames9.push({
        frame: 0,
    ...
    keyFrames9.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.005, currRot.y+0.177, currRot.z+0.28)
    });
    keyFrames9.push({
        frame: 3 * frameRate/4,     //45 frame
        value: new BABYLON.Vector3(currRot.x-0.102, currRot.y+0.206, currRot.z+0.26)
    });
    keyFrames9.push({
        frame: frameRate,
        value: new BABYLON.Vector3(currRot.x-0.109, currRot.y+0.319, currRot.z-0.262)
    });
    keyFrames9.push({
    ...
    const upperLegRRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames10 = [];
    keyFrames10.push({
        frame: 0,
        value: new BABYLON.Vector3(currRot.x+0.65, currRot.y-0.37, currRot.z+0.163)
    });
    keyFrames10.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+1.082, currRot.y-0.245, currRot.z-0.35)
    });
    keyFrames10.push({
        frame: 11 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.754, currRot.y-0.418, currRot.z+0.126)
    });
    keyFrames10.push({
        frame: 3 * frameRate/2,
    ...
    const lowerLegLRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames11 = [];
    keyFrames11.push({
        frame: 0,
    ...
    const lowerLegRRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames12 = [];
    keyFrames12.push({
        frame: 0,
    ...
    const footLRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames13 = [];
    keyFrames13.push({
        frame: 0,
    ...
    const footRRot = new BABYLON.Animation("walkRightRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    const keyFrames14 = [];
    keyFrames14.push({
        frame: 0,
...
function groupWalkRight(skeleton) {
    const walkRightGroup = new BABYLON.AnimationGroup("walkRightGroup");
    //walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("main")].animations[0], skeleton.bones[skeleton.getBoneIndexByName("main")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[6], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[7], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("head")].animations[1], skeleton.bones[skeleton.getBoneIndexByName("head")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder L")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("shoulder L")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("shoulder R")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot L")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("foot L")]);
    walkRightGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("foot R")]);

    return walkRightGroup;
}
