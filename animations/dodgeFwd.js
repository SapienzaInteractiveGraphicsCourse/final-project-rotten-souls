function dodgeForward(skeleton, frameRate, initialPos, initialRot) {
    var currPos;
    var currRot;
    ...
    const chestPos = new BABYLON.Animation("dodgeFwdPos", "position", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames1 = [];
    keyFrames1.push({
        frame: 0,
    ...
    const chestRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames2 = [];
    keyFrames2.push({
        frame: 0,
    ...
    const shoulderLRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames3 = [];
    keyFrames3.push({
        frame: 0,
        value: currRot
    ...
    const shoulderRRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames4 = [];
    keyFrames4.push({
        frame: 0,
        value: currRot
    ...
    const upperArmLRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames5 = [];
    keyFrames5.push({
        frame: 0,
    ...
    keyFrames5.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.352, currRot.y+0.818, currRot.z-0.982)
    });
    keyFrames5.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x-0.047, currRot.y+0.018, currRot.z-0.982)
    ...
    const upperArmRRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames6 = [];
    keyFrames6.push({
        frame: 0,
    ...
    keyFrames6.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.333, currRot.y-0.88, currRot.z+0.874)
    });
    keyFrames6.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.033, currRot.y-0.08, currRot.z+0.874)
    ...
    const lowerArmLRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames7 = [];
    keyFrames7.push({
        frame: 0,
    ...
    const lowerArmRRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames8 = [];
    keyFrames8.push({
        frame: 0,
    ...
    const palmRRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames9 = [];
    keyFrames9.push({
        frame: 0,
        value: currRot
    ...
    const upperLegLRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames10 = [];
    keyFrames10.push({
        frame: 0,
    ...
    keyFrames10.push({
        frame: 1 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x-0.276, currRot.y+0.234, currRot.z-0.302)
    });
    keyFrames10.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x-0.173, currRot.y+0.246, currRot.z-0.109)
    });
    keyFrames10.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.209, currRot.y+0.33, currRot.z-0.194)
    ...
    const upperLegRRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames11 = [];
    keyFrames11.push({
        frame: 0,
    ...
    keyFrames11.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+1.285, currRot.y-0.322, currRot.z-0.223)
    });
    keyFrames11.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.227, currRot.y-0.303, currRot.z+0.17)
    ...
    const lowerLegLRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames12 = [];
    keyFrames12.push({
        frame: 0,
    ...
    keyFrames12.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.48, currRot.y+0.027, currRot.z-0.029)
    });
    keyFrames12.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.204, currRot.y-0.034, currRot.z+0.06)
    ...
    const lowerLegRRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames13 = [];
    keyFrames13.push({
        frame: 0,
    ...
    keyFrames13.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.133, currRot.y+0.039, currRot.z-0.09)
    });
    keyFrames13.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x+0.305, currRot.y+0.024, currRot.z-0.018)
    ...
    const footLRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames14 = [];
    keyFrames14.push({
        frame: 0,
    ...
    keyFrames14.push({
        frame: 1 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x-0.28, currRot.y-0.019, currRot.z+0.3)
    });
    keyFrames14.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.228, currRot.y-0.032, currRot.z+0.254)
    });
    keyFrames14.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x-0.018, currRot.y+0.0, currRot.z+0.301)
    ...
    const footRRot = new BABYLON.Animation("dodgeFwdRot", "rotation", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    const keyFrames15 = [];
    keyFrames15.push({
        frame: 0,
    ...
    keyFrames15.push({
        frame: 5 * frameRate/12,
        value: new BABYLON.Vector3(currRot.x+0.434, currRot.y-0.063, currRot.z-0.259)
    });
    keyFrames15.push({
        frame: 5 * frameRate/6,
        value: new BABYLON.Vector3(currRot.x-0.12, currRot.y+0.0, currRot.z-0.3)
...
function groupDodgeFwd(skeleton) {
    const dodgeForwardGroup = new BABYLON.AnimationGroup("dodgeForwardGroup");
    dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[18], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("chest")].animations[19], skeleton.bones[skeleton.getBoneIndexByName("chest")]);
    //dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder L")].animations[5], skeleton.bones[skeleton.getBoneIndexByName("shoulder L")]);
    //dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("shoulder R")].animations[6], skeleton.bones[skeleton.getBoneIndexByName("shoulder R")]);
    dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")].animations[9], skeleton.bones[skeleton.getBoneIndexByName("upper_arm L")]);
    dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")].animations[9], skeleton.bones[skeleton.getBoneIndexByName("upper_arm R")]);
    dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")].animations[9], skeleton.bones[skeleton.getBoneIndexByName("lower_arm L")]);
    dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")].animations[9], skeleton.bones[skeleton.getBoneIndexByName("lower_arm R")]);
    dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("palm R")].animations[3], skeleton.bones[skeleton.getBoneIndexByName("palm R")]);
    dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")].animations[9], skeleton.bones[skeleton.getBoneIndexByName("upper_leg L")]);
    dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")].animations[9], skeleton.bones[skeleton.getBoneIndexByName("upper_leg R")]);
    dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")].animations[9], skeleton.bones[skeleton.getBoneIndexByName("lower_leg L")]);
    dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")].animations[9], skeleton.bones[skeleton.getBoneIndexByName("lower_leg R")]);
    dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot L")].animations[9], skeleton.bones[skeleton.getBoneIndexByName("foot L")]);
    dodgeForwardGroup.addTargetedAnimation(skeleton.bones[skeleton.getBoneIndexByName("foot R")].animations[9], skeleton.bones[skeleton.getBoneIndexByName("foot R")]);

    return dodgeForwardGroup;
}
